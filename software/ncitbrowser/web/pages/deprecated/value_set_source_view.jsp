...
<!--
  ipt type="text/javascript" src="<%= request.getContextPath() %>/js/yui/yahoo-min.js"></script><script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/event-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/dom-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/animation-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/container-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/connection-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/autocomplete-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/yui/treeview-min.js"></script> <script
  type="text/javascript" src="<%= request.getContextPath() %>/js/dropdown.js"></script>
-->
...
<html lang="en" xmlns:c="http://java.sun.com/jsp/jstl/core">
  <head>
    ...
    <style type="text/css">
      ...
      we turn them off as a foundation for YUI CSS treatments. */ body { margin:0; padding:0; }
    </style>
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="http://yui.yahooapis.com/2.9.0/build/treeview/assets/skins/sam/treeview.css"
    />
    ...
    <!-- Source file -->
    <!-- you require only basic HTTP transaction support, use the connection_core.js file. -->
    <script src="http://yui.yahooapis.com/2.9.0/build/connection/connection_core-min.js"></script>

    <!--
      the full connection.js if you require the following features: - Form serialization. - File Upload using the iframe
      transport. - Cross-domain(XDR) transactions.
    -->
    ...
    <style type="text/css">
      .ygtvcheck0 { background: url(
      <%= request.getContextPath() %>
      /images/yui/treeview/check0.gif) 0 0 no-repeat; width:16px; height:20px; float:left; cursor:pointer; } .ygtvcheck1
      { background: url(
      <%= request.getContextPath() %>
      /images/yui/treeview/check1.gif) 0 0 no-repeat; width:16px; height:20px; float:left; cursor:pointer; } .ygtvcheck2
      { background: url(
      <%= request.getContextPath() %>
      /images/yui/treeview/check2.gif) 0 0 no-repeat; width:16px; height:20px; float:left; cursor:pointer; }
      .ygtv-edit-TaskNode { width: 190px;} .ygtv-edit-TaskNode .ygtvcancel, .ygtv-edit-TextNode .ygtvok { border:none;}
      .ygtv-edit-TaskNode .ygtv-button-container { float: right;} .ygtv-edit-TaskNode .ygtv-input input{ width: 140px;}
    ...
    <!--
      ink rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/yui/fonts.css" /> <link
      rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/yui/grids.css" /> <link
      rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/yui/code.css" /> <link rel="stylesheet"
      type="text/css" href="<%= request.getContextPath() %>/css/yui/tree.css" /> --
    -->
                          ...
                          tree.subscribe("checkClick", function(node) {
                            ...
                            //YAHOO.util.Event.on('logHilit','click',function() {
                              ...
                              function check_all() {
                                ...
                                if (topNodes == null) {
                                  try {
                                    String error_msg = "WARNING: The server encountered an unexpected error (file: value_set_source_view.jsp, code: 1, var: topNodes).";
                              ...
                              function uncheck_all() {
                                ...
                                if (topNodes == null) {
                                  try {
                                    String error_msg = "WARNING: The server encountered an unexpected error (file: value_set_source_view.jsp, code: 2, var: topNodes).";
                                    request.getSession().setAttribute("error_msg", error_msg);
                                    String redirectURL = request.getContextPath() + "/pages/appscan_response.jsf";
                                    response.sendRedirect(redirectURL);
                                  } catch (Exception ex) {
                              ...
                              function getCheckedNodes(nodes) {
                                ...
                                for(var i=0, l=nodes.length; i<l; i=i+1) {
                                  ...
                                  if (n == null) {
                                    try {
                                      String error_msg = "WARNING: The server encountered an unexpected error (file: value_set_source_view.jsp, code: 3, var: n).";
                                      request.getSession().setAttribute("error_msg", error_msg);
                                      String redirectURL = request.getContextPath() + "/pages/appscan_response.jsf";
                                      response.sendRedirect(redirectURL);
                                    } catch (Exception ex) {
...
ga('set', 'anonymizeIP', true);
                                ...
                                <body onLoad="document.forms.valueSetSearchForm.matchText.focus();">
                                  <script type="text/javascript" src="<%= request.getContextPath() %>/js/wz_tooltip.js">
                                  </script>
                                  <script
                                      type="text/javascript"
                                      src="<%= request.getContextPath() %>/js/tip_centerwindow.js">
                                  </script>
                                  <script
                                      type="text/javascript"
                                      src="<%= request.getContextPath() %>/js/tip_followscroll.js">
                                  </script>
                                  <%!
                                  ...
                                  <f:view>
                                    ...
                                    <a
                                        ...
                                        class="skip-main"
                                        accesskey="1"
                                        title="Skip repetitive navigation links">
                                      ...
                                      <div id="main-area_960">
                                        ...
                                        <div class="bannerarea_960">
                                          <a href="<%=basePath%>/start.jsf" style="text-decoration: none;">
                                            <div class="vocabularynamebanner_tb">
                                              <span class="vocabularynamelong_tb">
                                          ...
                                          <div class="search-globalnav_960">
                                            ...
                                            <div class="searchbox-top">
                                              <img
                                                  src="<%=basePath%>/images/searchbox-top.gif"
                                                  width="352"
                                                  height="2"
                                                  alt="SearchBox Top"
                                              />
                                            ...
                                            <div class="searchbox-bottom">
                                              <img
                                                  src="<%=basePath%>/images/searchbox-bottom.gif"
                                                  width="352"
                                                  height="2"
                                        ...
                                        <div class="pagecontent">
                                          ...
                                          <p class="textbody">
                                            ...
                                            Standards categories group the value sets supporting them; all other labels
                                            lead to the home pages of actual value sets or source terminologies. Search
                                            or browse a value set from its home page, or search all value sets at once
                                            from this page (very slow) to find which ones contain a particular code or
                                            term.
                                          </p>
                                          ...
                                          <div id="popupContentArea">
                                            ...
                                            <tr class="textbody">
                                              ...
                                              <td class="textbody" align="left">
                                                ...
                                                <a
                                                    href="<%=request.getContextPath() %>/pages/value_set_source_view.jsf?&view=source">
                                          ...
                                          <style>
                                            #expandcontractdiv {border:1px solid #336600; background-color:#FFFFCC;
                                            margin:0 0 .5em 0; padding:0.2em;} #treecontainer { background: #fff }
                                          </style>
                                          ...
                                          <form id="pg_form" enctype="application/x-www-form-urlencoded;charset=UTF-8">
                                            ...
                                            <input
                                                ...
                                                id="schema"
                                                name="schema"
                                                value="<%=HTTPUtils.cleanXSS(schema)%>"
                                            />
                                            <input
                                                type="hidden"
                                                id="ontology_version"
                                        ...
                                        <div class="textbody"><%@ include file="/pages/templates/nciFooter.jsp" %></div>
                                    ...
                                    <div class="mainbox-bottom">
                                      <img
                                          src="<%=basePath%>/images/mainbox-bottom.gif"
                                          width="945"
                                          height="5"
                                          alt="Mainbox Bottom"
                                      />
