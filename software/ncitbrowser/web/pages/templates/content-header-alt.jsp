    ...
    <a
      ...
      <div class="vocabularynamebanner">
        <div
            ...
            STYLE="font-size: <%=HTTPUtils.maxFontSize(info.display_name)%>px; font-family : Arial">
        ...
        if (display_release_date) {
          ...
          <div class="vocabularynamelong">
            Version:<%= HTTPUtils.cleanXSS(info.term_browser_version) %> (Release date:<%= release_date %>)
          </div>
        <% } else { %>
